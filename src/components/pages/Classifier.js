...
const Classifier = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("/flask/user");
    ...
    const getQuestions = async () => {
        ...
        try {
            const response = await axios.get('/flask/question', {
                params: {
                    url: activeChat
                }
            });
    ...
    const handleSubmitUrl = async (inputUrl) => {
        ...
        try {
            ...
            const response = await axios.post('/flask/scrape', { url: inputUrl });
    ...
    const handleSubmitAnswers = async (answers) => {
        ...
        try {
            ...
            const response = await axios.post('/flask/submit_answer', { url, answers });
            setCategories(response.data.categories);
